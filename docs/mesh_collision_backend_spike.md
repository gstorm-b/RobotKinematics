...
D:\Project\RobotKinematics\_build_tools_msvc\mesh_collision_spike\release\mesh_collision_spike.exe
...
| ------------------------------------------------------------- | ------------------------------- | ------------ | ---------- | ------------ | ------------ |
| `collision_profiles/nachi_mz04d_mesh_collision.json`          | home (0,0,0,0,0,0 rad)          | 0            | 21         | 0.11350      | ~272         |
...
The simplified STLs land under `collision_profiles/simplified/<robot>/` and the simplified
