...
No UI, path planning, collision checking, dynamics, or trajectory generation. Only serial 6DOF
is implemented (no SCARA/delta/parallel). Modified (Craig) DH is not implemented.
