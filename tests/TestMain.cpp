...
int main(int argc, char** argv)
{
    ...
    status |= runSuite("CollisionApiTests", runCollisionApiTests, argc, argv);
    status |= runSuite("CollisionProfileValidatorTests", runCollisionProfileValidatorTests, argc, argv);
    status |= runSuite("CollisionCheckerTests", runCollisionCheckerTests, argc, argv);
    status |= runSuite("CollisionPrimitiveDistanceTests", runCollisionPrimitiveDistanceTests, argc, argv);
    status |= runSuite("StlPrimitiveAuthoringHelperTests", runStlPrimitiveAuthoringHelperTests, argc, argv);
    ...
    status |= runSuite("CollisionProfileJsonTests", runCollisionProfileJsonTests, argc, argv);
